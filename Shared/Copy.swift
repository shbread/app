...
If you allow **notifications** these are going to be displayed only for giving feedback on actions you take while using the app, we **don't** want to contact you in anyway and especifically we **don't** want to send you **Push Notifications**.
